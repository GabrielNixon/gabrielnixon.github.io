...
## Research Interests
<ul class="plain">
  <li>Q1) How agents adapt when even their underlying assumptions may be wrong.</li>
  <li>Q2) How systems should behave when coordination, rather than computation, becomes the primary bottleneck.</li>
</ul>
...
<div class="cards-grid">
  ...
  <div class="card">
    ...
    <p>[<a href="/assets/posters/GyoriLab-Poster.pdf">poster</a>]</p>
    <ul class="plain">
  ...
  <div class="card">
    ...
    <ul class="plain">
      ...
      <li><strong>Impact:</strong> Improved feature extraction for geospatial decision-making.</li>
    </ul>
  </div>
  <div class="card">
  ...
  <div class="card">
    ...
    <ul class="plain">
      ...
      <li><strong>Impact:</strong> Enabled real-time system summarization; presented at Berkeley Lab CS Program.</li>
    </ul>
  </div>
  <div class="card">
    ...
    <ul class="plain">
      ...
      <li><strong>Impact:</strong> Stabilized performance under structural noise.</li>
    </ul>
  </div>
</div>
...
<ul class="plain">
  <li>NYU Entrepreneurial Institute (2025): Built a RAG agent for multimodal document search.</li>
  <li>Impact Global Digital (2023–2024): Neural document search for healthcare logistics.</li>
  <li>The Tee Company (Co-Founder, 2022): Pricing and inventory optimization.</li>
  <li>Private Investor Research Group (2022–2023): Regime forecasting for portfolio allocation.</li>
</ul>

## Teaching Experience
<ul class="plain">
  <li>CUNY Geospatial Institute (2025): Graduate Geospatial AI tutorials.</li>
  <li>University of Munich (Summer 2025): Operations Research instruction.</li>
  <li>SIES GST (2022–2023): TA for Probabilistic Modeling.</li>
  <li>Father Agnel’s Ashram (2018–2020): Volunteer math educator.</li>
</ul>
