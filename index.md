...
<div class="hero">
  <img src="/assets/profile.jpg" alt="Gabriel Nixon Raj">
  <div>
    <h1>Gabriel Nixon Raj</h1>
    <div class="sub">
      Researcher in optimization, learning, and decision systems.  
      I study how systems adapt when their assumptions fail.
    </div>
    <div class="sub" style="margin-top:.3rem">
      NYU • CUNY Geospatial Institute • Northeastern (Gyori Lab) • LBNL
    </div>
    <div class="cta">
...
## News
- **Sep 2025** — NeurIPS Workshop (Gen AI in Finance) 2025 acceptance.
- **Aug 2025** — Finished LBNL AI internship; began NASA project at CUNY.
- **Jun 2025** — CMStatistics 2025 oral acceptance (University of London).
- **Mar 2025** — Offer for Summer AI internship at LBNL.
