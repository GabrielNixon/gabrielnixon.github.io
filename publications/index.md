...
### Selected
<ul class="plain">
  <li>Belief Distortion under Stress using Trust Decay and KL-Regularized Inference — CFE-CMStatistics, 2025.</li>
  ...
  <li>Adaptive and Regime-Aware RL for Portfolio Optimization — Preprint, 2025.</li>
</ul>

### Preprints
<ul class="plain">
  <li>Stress-Aware Learning under KL Drift via Trust-Decayed Mirror Descent — 2025.</li>
  <li>Adaptive and Regime-Aware RL for Portfolio Optimization — 2025.</li>
</ul>
...
<ul class="plain">
  ...
  <li>Automated Energy Billing with Blockchain and Prophet Forecasting — IEEE MRT, 2023.</li>
</ul>

### Journals & Book Chapters
<ul class="plain">
  <li>Smart Healthcare Companion with Tesseract OCR and KNN Integration — CRC Press, 2025.</li>
  <li>Leveraging CNN and IoT for Effective E-Waste Detection — IEEE I-SMAC, 2023.</li>
</ul>
